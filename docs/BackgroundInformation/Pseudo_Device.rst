...
Any generic LSLViewer can be used to view the generated data, example `viewers found on this link. <https://labstreaminglayer.readthedocs.io/info/viewers.html)>`.

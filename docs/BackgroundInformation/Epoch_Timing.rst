...
What are Epochs?
----------------
Defining epochs relates to the amount of time before and after a marker has been received we wish to process and analyse/extract features from out time series data for training models.

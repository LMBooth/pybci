...
**PyBCI** is a Python interface to create a Brain Computer Interface (BCI) with the `Lab Streaming Layer <https://github.com/sccn/labstreaminglayer>`_, `scikit-learn <https://scikit-learn.org/stable/#>`_ and `TensorFlow <https://www.tensorflow.org/install>`_ packages. Also leveraging packages like `Antropy <https://github.com/raphaelvallat/antropy>`_, `SciPy <https://scipy.org/>`_ and `NumPy <https://numpy.org/>`_ for time and/or frequency based feature exraction.
